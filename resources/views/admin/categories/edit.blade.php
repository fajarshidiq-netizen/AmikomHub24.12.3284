...
@section('content')
        <div class="mb-10">
            <a href="{{ route('admin.categories.index') }}" class="text-indigo-600 font-bold flex items-center gap-2 mb-6">
            ...
            <p class="text-slate-500 font-medium">Ubah nama dan slug kategori Anda.</p>
        </div>
        ...
        <div class="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm p-8 max-w-3xl">
            <form class="space-y-6">
                <div>
                    ...
                    <input type="text" value="Musik" placeholder="Contoh: Musik, Workshop, Seminar"
